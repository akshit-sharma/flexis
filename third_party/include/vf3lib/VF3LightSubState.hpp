...
namespace vflib
{
	...
	protected:
		...
		//Graphs to analyze
		const ARGraph<Node1, Edge1> *g1;
		const ARGraph<Node2, Edge2> *g2;
	...
	public:
		...
		VF3LightSubState(const ARGraph<Node1, Edge1> *g1, const ARGraph<Node2, Edge2> *g2,
	...
	template <typename Node1, typename Node2,
		...
		VF3LightSubState<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>
			::VF3LightSubState(const ARGraph<Node1, Edge1> *ag1, const ARGraph<Node2, Edge2> *ag2, 
		...
		VF3LightSubState<Node1, Node2, Edge1, Edge2, NodeComparisonFunctor, EdgeComparisonFunctor>::~VF3LightSubState()
	{
		...
		if (*share_count == 0)
		{
			delete[] dir;
			delete[] predecessors;
			free(core_len_c); //delete[] core_len_c;
		}
	}
